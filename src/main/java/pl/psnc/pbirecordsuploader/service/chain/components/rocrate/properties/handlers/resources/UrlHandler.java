...
@Component
public class UrlHandler extends ResourcesPropertyHandler {

    protected UrlHandler(ObjectMapper objectMapper, UrlValidator urlValidator,
    ...
    public Set<MetadataProperty> getSupportedTerms() {
        return Set.of(ContentProperties.URL);
    }
    ...
    public void handle(MetadataProperty metadataProperty, List<String> values, RoCrate.RoCrateBuilder builder,
        ...
        // do nothing for now, field not utilised
    }
}